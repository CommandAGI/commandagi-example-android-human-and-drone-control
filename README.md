# android-human-and-drone-control
...
```sh
git clone https://github.com/CommandAGI/commandagi-example-android-human-and-drone-control.git
cd commandagi-example-android-human-and-drone-control
```
